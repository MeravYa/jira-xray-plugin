...
public class JiraRestService {
    ...
    public Issue createTestIssue(String projectKey, @Nullable String assignee, @Nullable Iterable<String> components, String summary,
        ...
        try {
            ...
            fieldsJson.put("customfield_14709", new JSONObject().put("value", "Generic"));
            ...
            LOGGER.log(WARNING, "JIRA REST createTestIssue error: " + e.getMessage(), e);
        }
        return null;
    }

    public TestExecution createTestExecution(Issue test, String summary) {
        try {
            ...
            LOGGER.log(WARNING, "XRAY REST createTestExecution error: " + e.getMessage(), e);
        }
        return null;
    }

    public void updateTestExecutionStatus(Issue test, String testExecutionKey, ExecutionStatus testExecutionStatus) {
        try {
